$(document).ready(function () {
    ...
    let main = {
        ...
        attack : 0,
        // Initalize
        //remove all elements in the divs
        //Player Choice:
        // title: Please select your character
        //create button for select
        //place characters in the arena
        //On Click highlight character Choosen and assign data-player=true and src the player img remove from possible choice
        intialize: function () {
            docArena.empty();
            ...
            $("#select").on("click", function (event) {
                if(count==0){
                    ...
                    console.log(playerChar.charName);
